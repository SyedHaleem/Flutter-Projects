import 'package:doctor_project/views/auth_Screen/Registrations_Screen/RegScreen6.dart';
...
class RegScreen5 extends StatefulWidget {
  const RegScreen5({Key? key}) : super(key: key);

  @override
  State<RegScreen5> createState() => _RegScreen5State();
}
          ...
          children: [
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Step 5 of 7',softWrap: true,style: GoogleFonts.montserrat(fontWeight: FontWeight.w500,color: Color(0xFF191919),fontSize: 12),),
                  Heading_Text(text: 'Are You suffering with Diabetes?', fw: FontWeight.w700, fs: 15, fc: Colors.black, ls: -0.19, tp: 5),
                ],
              ),
            ),
            Padding(
                padding: EdgeInsets.only(top: 60),
                child: Center(child: Image.asset('assets/images/meter.png',height: 184.53,width: 180.5,))),
