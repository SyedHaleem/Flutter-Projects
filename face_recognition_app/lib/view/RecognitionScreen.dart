          ...
          child: ClipRRect(
            ...
            child: Stack(
              children: [
                ...
                if (controller.loadingState == RecognitionLoadingState.loadingImage ||
                    controller.loadingState == RecognitionLoadingState.detectingFaces)
                  Container(
        ...
        Row(
          ...
          children: [
            _gradientButton(
              icon: Icons.image,
              label: "Gallery",
              onTap: () => context.read<RecognitionController>().imgFromGallery(),
              width: screenWidth * 0.4,
            ),
            _gradientButton(
              icon: Icons.camera_alt,
              label: "Camera",
              onTap: () => context.read<RecognitionController>().imgFromCamera(),
              width: screenWidth * 0.4,
            ),
          ],
        ),
